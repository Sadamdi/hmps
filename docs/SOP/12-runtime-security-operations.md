...
SOP ini berlaku untuk middleware security, rate limit, cache, scheduler, backup/restore, web push, Vite dev runtime, Swagger/OpenAPI, and infrastructure helpers.
...
5. Keep service account and API credentials outside source-controlled examples.
...
1. Keep Swagger/OpenAPI generated/static files aligned with endpoints.
