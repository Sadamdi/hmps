...
# Prefer OPENAI_API_KEY_1…N (auto-rotate on limit/auth fail). Legacy OPENAI_API_KEY = slot 1 jika slot numbered tidak ada.
OPENAI_API_KEY_1=...
OPENAI_API_KEY_2=...
OPENAI_API_KEY_3=...
OPENAI_BASE_URL=https://api.openai.com/v1
OPENAI_MODELS=model-a,model-b,auto
# Opsional: cooldown ms setelah quota/auth fail per key slot (default 90000)
OPENAI_KEY_COOLDOWN_MS=90000
